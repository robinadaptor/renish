...
RESOURCES += src/qt/renish.qrc src/qt/renish_locale.qrc

TRANSLATIONS += src/qt/locale/renish_bg.ts \
                src/qt/locale/renish_de.ts \
                src/qt/locale/renish_en.ts \
                src/qt/locale/renish_es.ts \
                src/qt/locale/renish_fi.ts \
                src/qt/locale/renish_fr.ts \
                src/qt/locale/renish_it.ts \
                src/qt/locale/renish_ja.ts \
                src/qt/locale/renish_pl.ts \
                src/qt/locale/renish_pt.ts \
                src/qt/locale/renish_ru.ts \
                src/qt/locale/renish_sk.ts \
                src/qt/locale/renish_sv.ts \
                src/qt/locale/renish_vi.ts \
                src/qt/locale/renish_zh_CN.ts \
                src/qt/locale/renish_zh_TW.ts
