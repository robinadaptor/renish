...
In order to support loading of multiple wallets in renish-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is renish.cpp.
...
Changes to renish.cpp
----------------------
renish.cpp is the entry point into renish-qt, and as such, will require some minor modifications to provide hooks for
