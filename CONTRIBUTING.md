Contributing to Renish Core
============================

The Renish Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Renish Core project, and is not to be
confused with overall Renish Network Protocol consensus changes.

Whether a pull request is merged into Renish Core rests with the project merge
...
Patches that change Renish consensus rules are considerably more involved than
...
Where a patch set proposes to change the Renish consensus, it must have been
...
The project leader is the release manager for each Renish Core release.
