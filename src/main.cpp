...
#if defined(NDEBUG)
#error "Renish cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "Renish Signed Message:\n";
...
int64_t GetBlockValue(int nHeight)
{
	...
	if( nHeight > 1 && nHeight <= 4000 ) {
	        ...
	        nSubsidy = 200 * COIN;
	} else if( nHeight > 54000 && nHeight <= 200000 ) {
		nSubsidy = 100 * COIN;						
