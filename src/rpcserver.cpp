...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* RNSH features */
        {"renish", "masternode", &masternode, true, true, false},
        {"renish", "masternodelist", &masternodelist, true, true, false},
        {"renish", "mnbudget", &mnbudget, true, true, false},
        {"renish", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
        {"renish", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"renish", "mnsync", &mnsync, true, true, false},
        {"renish", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
        {"renish", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use renishd, or the -server option to renish-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> renish-cli " + methodname + " " + args + "\n";
}
