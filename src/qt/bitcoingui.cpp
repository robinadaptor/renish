...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a RNSH address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and renish: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Renish Core"), this);
    aboutAction->setStatusTip(tr("Show information about Renish Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Renish"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Renish addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Renish addresses"));
    ...
    openAction->setStatusTip(tr("Open a RNSH: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Renish Core help message to get a list with possible Renish command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Renish Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Renish network", "", count));
}
...
{
    QString strTitle = tr("Renish Core"); // default title
